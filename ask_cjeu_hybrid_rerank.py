...
with conn.cursor() as cur:
    ...
    for row in cur.fetchall():
        row_id, celex, url, paragraph_number, paragraph_index, text, vector_score, keyword_score = row
...
# 4. Pre-sort before GPT reranking
...
# keep reranking input manageable
